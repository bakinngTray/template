    ...
    return (
        ...
        <div className="header__MainDiv">
            <div className="header__group">
                <img src="img/player_default_album.png" alt=""></img>
                <img src="img/player_controls.png" alt=""></img>
            </div>

            <div>
                <a href="/"><img src="img/logo_static.png" alt=""></img></a>
            </div>

            <div className="header__group">
                <nav className="header__navigation">
                    <a href="./search_result" className="header__link header__ItemView"><img src="img/search.png" alt=""></img></a>
